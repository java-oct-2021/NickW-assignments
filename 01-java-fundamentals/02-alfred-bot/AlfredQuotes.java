...
public class AlfredQuotes {
    ...
    */
    public String guestGreeting(String name, String dayPeriod) {
        // YOUR CODE HERE
        return "Good " + dayPeriod + name + " , it's lovely to have you back";
    }
    /* 
    * Inputs: None
    * Return Type: String
    ...
    */
    public String respondBeforeAlexis(String conversation) {
        ...
        if(conversation.contains("Alexis")) {
            return "Right Away. She clearly isn't formidable enough.";
        }

        if (conversation.contains("Alfred")) {
            return "As you wish. Right away.";
        }

        return "Certainly. And with that, I shall retire.";
